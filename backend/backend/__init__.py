...
def create_app(db_path=os.environ.get('POSTGRES_PATH')):
    ...
    api.add_resource(LtcManager.GetPendingAdvancePaymentRequests, '/api/get-pending-advance-payments')
    api.add_resource(LtcManager.UpdateAdvancePaymentDetails, '/api/update-advance-payment')
