...
import UploadTAOfficeOrder from './UploadTAOfficeOrder';
    ...
    <div>
      ...
      <Box className={classes.wrapper}>
        <Routes>
          ...
          <Route path="/office_orders-ta" element={<UploadTAOfficeOrder permission={props.profileInfo.permission} />}></Route>
