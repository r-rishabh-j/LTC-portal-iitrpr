...
function TAPayments() {
    ...
    useEffect(() => {
        fetch("/api/ta/pending-payment-requests")
            .then((data) => data.json())
            .then((data) => {
                console.log(data);
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <TADialogBox request_id={id} status="payment_pending" />
                    <DialogActions>
                ...
                >
                    <AdvancePaymentDialogBox request_id={id} api="/api/ta/upload-payment-details" />
                    <DialogActions>
